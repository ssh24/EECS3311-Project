...
extern EIF_TYPED_VALUE F932_9649(EIF_REFERENCE);
extern void F932_25618(EIF_REFERENCE, int);
...
/* {ETF_MODEL_ACCESS}.m */
RTOID (F932_9649)
EIF_TYPED_VALUE F932_9649 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 931, Current, 0, 0, 15330);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(931, Current, 15330);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
void F932_25618 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 931, Current, 0, 25617);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT(NULL, Current);
