...
extern EIF_TYPED_VALUE F952_9862(EIF_REFERENCE);
extern EIF_TYPED_VALUE F952_9863(EIF_REFERENCE);
...
RTOID (F952_9862)
EIF_TYPED_VALUE F952_9862 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 951, Current, 0, 0, 15542);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(951, Current, 15542);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F952_9863)
EIF_TYPED_VALUE F952_9863 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 951, Current, 0, 0, 15543);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(951, Current, 15543);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
{
	GTCX
	RTOTS (9862,F952_9862)
	RTOTS (9863,F952_9863)
}
