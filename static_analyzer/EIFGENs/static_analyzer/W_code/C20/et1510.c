...
extern void F1510_16860(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1510_16860 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1509, Current, 0, 1, 22609);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1509, Current, 22609);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	tr2 = RTLN(1287);
	ui4_1 = arg1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(11702, Dtype(tr2)))(tr2, ui4_1x);
	
	RTNHOOK(1,2);
	ur1 = RTCCL(tr2);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(7620, "insert_integer", tr1))(tr1, ur1x);
