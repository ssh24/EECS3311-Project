...
extern void F1496_16839(EIF_REFERENCE);
...
void F1496_16839 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1495, Current, 0, 0, 22595);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1495, Current, 22595);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (tb1) {
		...
		RTNHOOK(3,1);
		tr2 = RTLN(1277);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(11692, Dtype(tr2)))(tr2);
