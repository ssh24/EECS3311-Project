...
extern void F1512_16863(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1512_16863 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1511, Current, 3, 1, 22611);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1511, Current, 22611);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	tr2 = RTLN(1286);
	ub1 = arg1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(11700, Dtype(tr2)))(tr2, ub1x);
	
	RTNHOOK(1,2);
	ur1 = RTCCL(tr2);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(7621, "insert_boolean", tr1))(tr1, ur1x);
