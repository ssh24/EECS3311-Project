...
extern void F1502_16848(EIF_REFERENCE);
...
void F1502_16848 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1501, Current, 0, 0, 22601);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1501, Current, 22601);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (tb1) {
		...
		RTNHOOK(3,1);
		tr2 = RTLN(1284);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(11699, Dtype(tr2)))(tr2);
