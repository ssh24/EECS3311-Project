...
extern void F1508_16857(EIF_REFERENCE);
...
void F1508_16857 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1507, Current, 0, 0, 22607);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1507, Current, 22607);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (tb1) {
		...
		RTNHOOK(3,1);
		tr2 = RTLN(1282);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(11697, Dtype(tr2)))(tr2);
