...
extern void F1501_16846(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void EIF_Minit1501(void);
extern EIF_REFERENCE _A1501_49();
...
void F1501_16846 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ur3 ur3x.it_r
	...
	RTEAA(l_feature_name, 1500, Current, 0, 3, 22600);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1500, Current, 22600);
	RTCC(arg1, 1500, l_feature_name, 1, eif_attached_type(219));
	{
		...
		RTCC(arg2, 1500, l_feature_name, 2, eif_attached_type(typres0));
	}
	RTCC(arg3, 1500, l_feature_name, 3, eif_attached_type(1059));
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	ur2 = RTCCL(arg2);
	...
	
	{
		...
		typres0 = eif_compound_id(dftype, typarr0);
		tr2 = RTLNRW(typres0, 0, (EIF_POINTER) _A1501_49, (EIF_POINTER)(0),14161, 0, 0, 1, -1, tr1, 0);
	}
	RTAR(Current, tr2);
