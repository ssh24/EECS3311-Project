...
extern void F1504_16851(EIF_REFERENCE);
...
void F1504_16851 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1503, Current, 0, 0, 22603);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1503, Current, 22603);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (tb1) {
		...
		RTNHOOK(3,1);
		tr2 = RTLN(1274);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(11689, Dtype(tr2)))(tr2);
