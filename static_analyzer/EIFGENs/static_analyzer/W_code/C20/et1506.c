...
extern void F1506_16854(EIF_REFERENCE);
...
void F1506_16854 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1505, Current, 0, 0, 22605);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1505, Current, 22605);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (tb1) {
		...
		RTNHOOK(3,1);
		tr2 = RTLN(1281);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(11696, Dtype(tr2)))(tr2);
