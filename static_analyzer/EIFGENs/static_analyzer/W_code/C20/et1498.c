...
extern void F1498_16842(EIF_REFERENCE);
...
void F1498_16842 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1497, Current, 0, 0, 22597);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1497, Current, 22597);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (tb1) {
		...
		RTNHOOK(3,1);
		tr2 = RTLN(1275);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(11690, Dtype(tr2)))(tr2);
