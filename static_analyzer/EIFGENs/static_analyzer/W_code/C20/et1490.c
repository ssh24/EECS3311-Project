...
extern void F1490_16830(EIF_REFERENCE);
...
void F1490_16830 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1489, Current, 0, 0, 22589);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1489, Current, 22589);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (tb1) {
		...
		RTNHOOK(3,1);
		tr2 = RTLN(1273);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(11688, Dtype(tr2)))(tr2);
