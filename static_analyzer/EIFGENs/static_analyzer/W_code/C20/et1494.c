...
extern void F1494_16836(EIF_REFERENCE);
...
void F1494_16836 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1493, Current, 0, 0, 22593);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1493, Current, 22593);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (tb1) {
		...
		RTNHOOK(3,1);
		tr2 = RTLN(1283);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(11698, Dtype(tr2)))(tr2);
