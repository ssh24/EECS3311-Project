...
extern EIF_TYPED_VALUE F972_10147(EIF_REFERENCE);
...
RTOID (F972_10147)
EIF_TYPED_VALUE F972_10147 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 971, Current, 0, 0, 15825);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(971, Current, 15825);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
