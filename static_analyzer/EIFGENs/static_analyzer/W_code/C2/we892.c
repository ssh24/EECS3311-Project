...
extern EIF_TYPED_VALUE F892_8818(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F892_8818 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_n4
	...
	RTEAA(l_feature_name, 891, Current, 0, 1, 14457);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	tu4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6742, dtype))(Current)).it_n4);
	tu4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6743, dtype))(Current)).it_n4);
	tu4_3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6744, dtype))(Current)).it_n4);
	tu4_4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6745, dtype))(Current)).it_n4);
