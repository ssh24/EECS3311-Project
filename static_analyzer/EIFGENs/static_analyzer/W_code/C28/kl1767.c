...
extern EIF_TYPED_VALUE F1767_20328(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1767_20328 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1766, Current, 0, 0, 25624);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1766, Current, 25624);
	RTIV(Current, RTAL);
	RTHOOK(1);
