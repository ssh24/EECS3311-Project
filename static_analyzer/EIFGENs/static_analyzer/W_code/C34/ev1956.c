...
extern void F1956_25382(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1956_25383(EIF_REFERENCE);
extern void F1956_25384(EIF_REFERENCE);
extern void F1956_25385(EIF_REFERENCE);
static EIF_TYPED_VALUE F1956_25386_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1956_25386(EIF_REFERENCE);
extern void F1956_25387(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1956_25388(EIF_REFERENCE);
...
void F1956_25382 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1955, Current, 0, 0, 30401);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1955, Current, 30401);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(15697, 1954))(Current);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 19980, 0x04000000, 1); /* is_selected */
...
EIF_TYPED_VALUE F1956_25383 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F1956_25384 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1955, Current, 0, 0, 30403);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1955, Current, 30403);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 19980, 0x04000000, 1); /* is_selected */
	
	*(EIF_BOOLEAN *)(Current + RTWA(19980, Dtype(Current))) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
void F1956_25385 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1955, Current, 4, 0, 30404);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1955, Current, 30404);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	...
	if (tb1) {
		...
		for (;;) {
			...
			ui4_1 = ti4_1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(14493, "uncheck_item", loc3))(loc3, ui4_1x);
			
			RTHOOK(6);
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1741, "item", loc2))(loc2)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			
			RTNHOOK(6,1);
			(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(18119, "disable_select", tr1))(tr1);
	...
	*(EIF_BOOLEAN *)(Current + RTWA(19980, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	...
	if (tb2) {
		...
		ui4_1 = ti4_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(14492, "check_item", loc4))(loc4, ui4_1x);
		
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(12);
		RTCT("selected", EX_POST);
		tb2 = *(EIF_BOOLEAN *)(Current + RTWA(19980, dtype));
		if (tb2) {
			RTCK;
		} else {
			RTCF;
...
static EIF_TYPED_VALUE F1956_25386_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1955, Current, 0, 0, 30405);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1955, Current, 30405);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1956_25386 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15702, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1956_25386_body (Current)).it_r;
...
void F1956_25387 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1955, Current, 0, 0, 30406);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1955, Current, 30406);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1956_25388 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1955, Current, 0, 0, 30407);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1955, Current, 30407);
	RTIV(Current, RTAL);
	RTHOOK(1);
