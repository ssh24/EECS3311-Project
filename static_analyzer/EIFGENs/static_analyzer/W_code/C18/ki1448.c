...
extern void F1448_16463(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1448_16464(EIF_REFERENCE);
...
void F1448_16463 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1447, Current, 0, 1, 22209);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1447, Current, 22209);
	RTCC(arg1, 1447, l_feature_name, 1, eif_attached_type(219));
	RTIV(Current, RTAL);
...
body:;
	...
	RTHOOK(4);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(13838, dtype))(Current);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
	RTDBGLE;
...
void F1448_16464 (EIF_REFERENCE Current)
{
	GTCX
