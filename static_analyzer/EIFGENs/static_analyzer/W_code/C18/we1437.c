...
extern void F1437_16416(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1437_16417(EIF_REFERENCE);
extern void F1437_16418(EIF_REFERENCE);
extern void F1437_16419(EIF_REFERENCE);
extern void F1437_25646(EIF_REFERENCE, int);
...
void F1437_16416 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1436, Current, 0, 1, 22166);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1436, Current, 22166);
	RTCC(arg1, 1436, l_feature_name, 1, eif_attached_type(164));
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 13803, 0xF80000A4, 0); /* file */
	
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(13803, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	RTHOOK(5);
...
EIF_TYPED_VALUE F1437_16417 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(13803,Dtype(Current)));
	return r;
}


/* {WEL_RICH_EDIT_FILE_SAVER}.write_buffer */
void F1437_16418 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1436, Current, 1, 0, 22168);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1436, Current, 22168);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	ui4_2 = ti4_1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(2864, "put_managed_pointer", tr1))(tr1, ur1x, ui4_1x, ui4_2x);
...
void F1437_16419 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1436, Current, 0, 0, 22169);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1436, Current, 22169);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(13803, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(1,1);
...
void F1437_25646 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1436, Current, 0, 25645);
	RTSA(dtype);
	RTME(dtype, 0);
