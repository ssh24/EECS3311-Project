...
extern void F1715_19886(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1715_19887_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1715_19887(EIF_REFERENCE);
...
void F1715_19886 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1714, Current, 1, 1, 25383);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1714, Current, 25383);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		...
		RTNHOOK(4,2);
		ub1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(16729, "update_for_pick_and_drop", tr2))(tr2, ub1x);
...
static EIF_TYPED_VALUE F1715_19887_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1714, Current, 0, 0, 25384);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1714, Current, 25384);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1715_19887 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15702, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1715_19887_body (Current)).it_r;
