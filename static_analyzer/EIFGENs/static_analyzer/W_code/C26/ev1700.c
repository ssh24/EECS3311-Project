...
extern void F1700_19695(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1700_19696_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1700_19696(EIF_REFERENCE);
...
void F1700_19695 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1699, Current, 1, 1, 25293);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1699, Current, 25293);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(4);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16396, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(4,1);
		...
		RTNHOOK(4,2);
		ub1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(16392, "update_for_pick_and_drop", tr2))(tr2, ub1x);
...
static EIF_TYPED_VALUE F1700_19696_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1699, Current, 0, 0, 25294);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1699, Current, 25294);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1700_19696 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15702, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1700_19696_body (Current)).it_r;
