...
extern EIF_TYPED_VALUE F1587_18238(EIF_REFERENCE);
extern void F1587_18239(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1587_18238 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1587_18239 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1586, Current, 0, 0, 24106);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1586, Current, 24106);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14815, 0xF80006A7, 0); /* implementation */
