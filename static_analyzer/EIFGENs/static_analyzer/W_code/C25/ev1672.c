...
static EIF_TYPED_VALUE F1672_19394_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1672_19394(EIF_REFERENCE);
extern void F1672_25701(EIF_REFERENCE, int);
...
static EIF_TYPED_VALUE F1672_19394_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1671, Current, 0, 0, 25076);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1671, Current, 25076);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1672_19394 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15702, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1672_19394_body (Current)).it_r;
...
void F1672_25701 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1671, Current, 0, 25700);
	RTSA(dtype);
	RTME(dtype, 0);
