...
extern EIF_TYPED_VALUE F1171_12844(EIF_REFERENCE);
...
RTOID (F1171_12844)
EIF_TYPED_VALUE F1171_12844 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1170, Current, 0, 0, 18342);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1170, Current, 18342);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
