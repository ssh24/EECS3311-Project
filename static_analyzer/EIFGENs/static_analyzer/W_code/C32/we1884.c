...
extern void F1884_23149(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1884_23150(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1884_23151(EIF_REFERENCE);
extern void F1884_23152(EIF_REFERENCE);
extern void F1884_23153(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1884_23154(EIF_REFERENCE);
...
/* {WEL_BUTTON}.make */
void F1884_23149 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x, EIF_TYPED_VALUE arg4x, EIF_TYPED_VALUE arg5x, EIF_TYPED_VALUE arg6x, EIF_TYPED_VALUE arg7x)
{
	GTCX
...
#define ui4_6 ui4_6x.it_i4
	...
	RTEAA(l_feature_name, 1883, Current, 0, 7, 28308);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1883, Current, 28308);
	RTCC(arg1, 1883, l_feature_name, 1, eif_attached_type(1854));
	RTCC(arg2, 1883, l_feature_name, 2, eif_attached_type(216));
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1884_23150 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1883, Current, 0, 0, 28309);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1883, Current, 28309);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
EIF_TYPED_VALUE F1884_23151 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1883, Current, 0, 0, 28310);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1883, Current, 28310);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
void F1884_23152 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1883, Current, 0, 0, 28311);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1883, Current, 28311);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
void F1884_23153 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1883, Current, 0, 1, 28312);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1883, Current, 28312);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
RTOID (F1884_23154)
EIF_TYPED_VALUE F1884_23154 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1883, Current, 0, 0, 28313);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1883, Current, 28313);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
