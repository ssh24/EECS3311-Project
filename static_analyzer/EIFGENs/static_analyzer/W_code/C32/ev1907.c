...
extern void F1907_23595(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1907_23596(EIF_REFERENCE);
extern void F1907_23597(EIF_REFERENCE);
extern void F1907_23598(EIF_REFERENCE);
extern void F1907_23599(EIF_REFERENCE);
static EIF_TYPED_VALUE F1907_23600_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1907_23600(EIF_REFERENCE);
...
void F1907_23595 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1906, Current, 0, 0, 28736);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1906, Current, 28736);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(15697, 1903))(Current);
	RTHOOK(2);
...
EIF_TYPED_VALUE F1907_23596 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(19361,Dtype(Current)));
	return r;
}


/* {EV_TOOL_BAR_RADIO_BUTTON_IMP}.enable_select */
void F1907_23597 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1906, Current, 1, 0, 28738);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1906, Current, 28738);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (RTAL & CK_ENSURE) {
		...
		tb1 = *(EIF_BOOLEAN *)(Current + RTWA(19361, dtype));
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
void F1907_23598 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1906, Current, 1, 0, 28739);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1906, Current, 28739);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 19361, 0x04000000, 1); /* is_selected */
	
	*(EIF_BOOLEAN *)(Current + RTWA(19361, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	RTHOOK(2);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(19356, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc1 = RTCCL(tr1);
	if (EIF_TEST(loc1)) {
...
void F1907_23599 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1906, Current, 2, 0, 28740);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1906, Current, 28740);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(loc2 != NULL)) {
		...
		for (;;) {
			...
			if (!RTCEQ(tr1, Current)) {
				...
				RTNHOOK(7,1);
				(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(19359, "disable_select", tr1))(tr1);
	...
	*(EIF_BOOLEAN *)(Current + RTWA(19361, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(11);
	RTDBGLE;
...
static EIF_TYPED_VALUE F1907_23600_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1906, Current, 0, 0, 28741);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1906, Current, 28741);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1907_23600 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15702, Dtype(Current), Dftype(Current)))) {
			...
			RTLI(1);
			RTLR(0,Current);
			r.it_r = (F1907_23600_body (Current)).it_r;
