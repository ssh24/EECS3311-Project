...
extern EIF_TYPED_VALUE F1298_14209(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1298_14209 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1297, Current, 0, 1, 19805);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1297, Current, 19805);
	RTCC(arg1, 1297, l_feature_name, 1, eif_attached_type(219));
	RTIV(Current, RTAL);
	RTHOOK(1);
