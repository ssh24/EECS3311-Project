...
extern EIF_TYPED_VALUE F1108_11835(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1108_11835 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1107, Current, 0, 0, 17445);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1107, Current, 17445);
	RTIV(Current, RTAL);
	RTHOOK(1);
