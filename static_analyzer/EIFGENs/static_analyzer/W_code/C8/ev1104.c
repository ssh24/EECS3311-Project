...
extern EIF_TYPED_VALUE F1104_11804(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1104_11804 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1103, Current, 0, 0, 17415);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1103, Current, 17415);
	RTIV(Current, RTAL);
	RTHOOK(1);
