...
extern void F1786_20705(EIF_REFERENCE);
extern void F1786_20706(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1786_20707(EIF_REFERENCE);
...
void F1786_20705 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1785, Current, 4, 0, 25945);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1785, Current, 25945);
	RTIV(Current, RTAL);
...
void F1786_20706 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1785, Current, 0, 0, 25946);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1785, Current, 25946);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_open_read", EX_PRE);
...
EIF_TYPED_VALUE F1786_20707 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1786_20707,25948,RTMS_EX_H("\012",1,10));
}

void EIF_Minit1786 (void)
{
	GTCX
	RTOTS (20707,F1786_20707)
}
