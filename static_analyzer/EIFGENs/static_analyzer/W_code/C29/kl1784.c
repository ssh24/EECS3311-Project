...
extern EIF_TYPED_VALUE F1784_20698(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1784_20699(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1784_20700(EIF_REFERENCE);
extern void F1784_20701(EIF_REFERENCE);
extern void F1784_20702(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1784_20698 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_CHAR8;
...
EIF_TYPED_VALUE F1784_20699 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1784_20700 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1784_20700,25941,RTMS_EX_H("\012",1,10));
}

/* {KL_TEXT_INPUT_FILE}.read_line */
void F1784_20701 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1783, Current, 5, 0, 25941);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1783, Current, 25941);
	RTIV(Current, RTAL);
...
body:;
	...
	loc2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(17215, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	for (;;) {
		RTHOOK(6);
		if (loc1) break;
		RTHOOK(7);
		...
		RTHOOK(8);
		tb1 = *(EIF_BOOLEAN *)(Current + RTWA(17214, dtype));
		if (tb1) {
			RTHOOK(9);
			...
			loc3 = *(EIF_CHARACTER_8 *)(Current + RTWA(17216, dtype));
			RTHOOK(12);
			switch (loc3) {
	...
	*(EIF_BOOLEAN *)(Current + RTWA(17214, dtype)) = (EIF_BOOLEAN) loc4;
	if (RTAL & CK_ENSURE) {
		RTHOOK(20);
...
void F1784_20702 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1783, Current, 0, 0, 25942);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1783, Current, 25942);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_open_read", EX_PRE);
