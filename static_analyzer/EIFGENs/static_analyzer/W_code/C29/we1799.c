...
extern EIF_TYPED_VALUE F1799_20845(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1799_20846(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1799_20845 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1798, Current, 0, 0, 26085);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1798, Current, 26085);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1799_20846 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1798, Current, 0, 0, 26086);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1798, Current, 26086);
	RTIV(Current, RTAL);
	RTHOOK(1);
