...
extern void F1482_16818(EIF_REFERENCE);
...
void F1482_16818 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1481, Current, 0, 0, 22581);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1481, Current, 22581);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (tb1) {
		...
		RTNHOOK(3,1);
		tr2 = RTLN(1268);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(11678, Dtype(tr2)))(tr2);
		
		RTNHOOK(3,2);
		ur1 = RTCCL(tr2);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(7623, "insert_unary_op_expression", tr1))(tr1, ur1x);
