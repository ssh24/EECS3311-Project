...
extern void F1481_16816(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void EIF_Minit1481(void);
extern EIF_REFERENCE _A1481_49();
...
void F1481_16816 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ur3 ur3x.it_r
	...
	RTEAA(l_feature_name, 1480, Current, 0, 3, 22580);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1480, Current, 22580);
	RTCC(arg1, 1480, l_feature_name, 1, eif_attached_type(219));
	{
		...
		RTCC(arg2, 1480, l_feature_name, 2, eif_attached_type(typres0));
	}
	RTCC(arg3, 1480, l_feature_name, 3, eif_attached_type(1059));
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	ur2 = RTCCL(arg2);
	...
	
	{
		...
		typres0 = eif_compound_id(dftype, typarr0);
		tr2 = RTLNRW(typres0, 0, (EIF_POINTER) _A1481_49, (EIF_POINTER)(0),14151, 0, 0, 1, -1, tr1, 0);
	}
	RTAR(Current, tr2);
