...
extern EIF_TYPED_VALUE F1003_10417(EIF_REFERENCE);
...
RTOID (F1003_10417)
EIF_TYPED_VALUE F1003_10417 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1002, Current, 0, 0, 16079);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1002, Current, 16079);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
