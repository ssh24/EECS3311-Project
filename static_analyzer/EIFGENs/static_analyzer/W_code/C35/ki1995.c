...
extern EIF_TYPED_VALUE F1995_12380(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1995_12381(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1995_12383(EIF_REFERENCE);
extern void F1995_12388(EIF_REFERENCE);
extern void F1995_12389(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1995_12380 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1994, Current, 2, 3, 17953);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1994, Current, 17953);
	{
		static EIF_TYPE_INDEX typarr0[] = {1995,0,0xFFFF};
		EIF_TYPE_INDEX typres0;
		typarr0[1] = RTWCT(10263, dtype, Dftype(Current));
		
		typres0 = eif_compound_id(Dftype(Current), typarr0);
		RTCC(arg1, 1994, l_feature_name, 1, eif_attached_type(typres0));
	}
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		if ((EIF_BOOLEAN) !tb1) {
			RTHOOK(12);
			tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10260, dtype))(Current)).it_c1);
			uc1 = tc1;
			ui4_1 = loc1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(9163, "put", arg1))(arg1, uc1x, ui4_1x);
...
EIF_TYPED_VALUE F1995_12381 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1994, Current, 0, 0, 17954);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1994, Current, 17954);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1995_12383 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1994, Current, 0, 0, 17955);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1994, Current, 17955);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F1995_12388 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1994, Current, 0, 0, 17956);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1994, Current, 17956);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F1995_12389 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1994, Current, 0, 0, 17957);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1994, Current, 17957);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
