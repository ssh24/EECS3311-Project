...
extern EIF_TYPED_VALUE F1990_19276(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1990_19277(EIF_REFERENCE);
extern void F1990_19278(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1990_19279(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1990_19276 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1989, Current, 2, 1, 24990);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1989, Current, 24990);
	RTIV(Current, RTAL);
...
body:;
	...
	if ((EIF_TRUE)) {
		...
		loc2 = RTCCL(tr1);
		loc2 = RTRV(eif_non_attached_type(RTWCT(16036, dtype, Dftype(Current))),loc2);
		tb1 = EIF_TEST(loc2);
	}
	if (tb1) {
		RTCK0;
...
EIF_TYPED_VALUE F1990_19277 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1989, Current, 0, 0, 24991);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1989, Current, 24991);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16071, Dtype(Current)))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(1,1);
...
void F1990_19278 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1989, Current, 1, 2, 24992);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1989, Current, 24992);
	RTCC(arg1, 1989, l_feature_name, 1, eif_attached_type(RTWCT(16036, dtype, Dftype(Current))));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("i_within_bounds", EX_PRE);
...
void F1990_19279 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1989, Current, 0, 1, 24993);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1989, Current, 24993);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("i_within_bounds", EX_PRE);
