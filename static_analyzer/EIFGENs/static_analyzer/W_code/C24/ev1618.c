...
extern EIF_TYPED_VALUE F1618_18629(EIF_REFERENCE);
extern void F1618_18630(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1618_18629 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1618_18630 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1617, Current, 0, 0, 24500);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1617, Current, 24500);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14815, 0xF80006C6, 0); /* implementation */
