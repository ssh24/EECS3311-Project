...
extern EIF_TYPED_VALUE F1631_18687(EIF_REFERENCE);
extern void F1631_18688(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1631_18687 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1631_18688 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1630, Current, 0, 0, 24556);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1630, Current, 24556);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14815, 0xF80006CF, 0); /* implementation */
